...
class test {
	...
	function try_include_filepath ( string $filepath, array $context = [] ) {
		// function extracted to be easily customized by overwriting this method
		...
		{
			$this->test_spec_error_exit('File not found: "'.$filepath.'".');
		}
	}
	...
	function array_structure_valid ( $array_to_validate, ...$structure_or_alt ) :? array {
		...
		// e.g.: [ 'success' => "bool", 'data' => [ 'rows' => "array"], 'some_o_key' => "int" /* or "integer" */ ]
